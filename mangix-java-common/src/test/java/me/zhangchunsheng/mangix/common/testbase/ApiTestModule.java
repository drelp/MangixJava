...
import me.zhangchunsheng.mangix.common.service.impl.MangixServiceImpl;
...
public class ApiTestModule implements Module {
    ...
    public void configure(Binder binder) {
        try (InputStream inputStream = ClassLoader.getSystemResourceAsStream(TEST_CONFIG_XML)) {
            ...
            MangixService mangixService = new MangixServiceImpl();
            mangixService.setConfig(config);

            binder.bind(MangixService.class).toInstance(mangixService);
