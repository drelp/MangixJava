...
/**
 * JumpServer请求实现类，jodd-http实现.
 * Created by Chunsheng Zhang on 2022/4/2.
 *
 * @author <a href="https://github.com/zhangchunsheng">Chunsheng Zhang</a>
 */
public class MangixServiceJoddHttpImpl extends BaseServiceImpl {
    @Override
    ...
    public String post(String url, Map<String, Object> params) throws MangixException {
        String requestStr = MangixServiceJoddHttpImpl.getUrlParams(params);
    ...
    private HttpRequest buildHttpGet(String url) throws MangixException {
        HttpRequest request = HttpRequest
                .get(url)
                .timeout(this.getConfig().getHttpTimeout())
                .connectionTimeout(this.getConfig().getHttpConnectionTimeout());
    ...
    private String getResponseString(HttpResponse response) throws MangixException {
        try {
        ...
        if (StringUtils.isBlank(responseString)) {
            throw new MangixException("响应信息为空");
        }
